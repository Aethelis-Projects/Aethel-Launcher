...
pub async fn start_installation(config: InstallConfig, app: AppHandle) -> Result<(), String> {
    ...
    tokio::spawn(async move {
        ...
        emit_progress(
            ...
            "0 MB/s",
            "--",
            "[INFO] Checking install destination...",
        );
        ...
        emit_progress(
            ...
            "15.4 MB/s",
            "8s",
            "[INFO] Resolving release binary from GitHub...",
        );
        let (launcher_url, _sig_url) =
        ...
        emit_progress(
            ...
            "22.1 MB/s",
            "5s",
            &format!("[INFO] Asset URL: {launcher_url}"),
        );
        ...
        emit_progress(
            ...
            "48.2 MB/s",
            "3s",
            "[INFO] Extracting runtime files safely with Zip-Slip protection...",
        );
        ...
        if config.components.contains(&Component::Java21) {
            emit_progress(
                ...
                "28.5 MB/s",
                "4s",
                "[INFO] Downloading Adoptium OpenJDK 21 LTS runtime...",
            );
        ...
        emit_progress(
            ...
            "0 MB/s",
            "1s",
            "[INFO] Writing install-manifest.json and uninstall.cmd...",
        );
