...
export const CompletionScreen: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-full px-8 py-5 relative z-10 select-none text-center justify-between">
      {/* Celebration Checkmark */}
      <div className="flex-1 flex flex-col items-center justify-center -mt-1">
        <div className="relative mb-3">
          <div className="absolute inset-0 rounded-full blur-xl bg-cyan-400/30 animate-pulse" />
          <div className="w-16 h-16 rounded-full bg-gradient-to-tr from-cyan-500 to-blue-600 flex items-center justify-center text-slate-950 shadow-[0_0_24px_rgba(0,245,212,0.5)] relative z-10">
            <CheckCircle2 className="w-8 h-8 stroke-[2.5]" />
          </div>
        </div>

        <h1 className="text-xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-sky-300 to-purple-400 mb-1">
          {t('completion.title')}
        </h1>
        ...
        {/* Launch checkbox */}
        <label className="flex items-center gap-3 px-4 py-2 rounded-xl bg-slate-900/60 border border-slate-800 hover:border-cyan-500/40 transition-colors cursor-pointer mb-4">
          <input
            type="checkbox"
        ...
        <div className="flex items-center gap-3 text-xs text-slate-400">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-slate-950/80 border border-slate-800 hover:border-indigo-500/50 hover:text-indigo-300 transition-colors cursor-pointer"
          >
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-slate-950/80 border border-slate-800 hover:border-slate-600 hover:text-slate-200 transition-colors cursor-pointer"
          >
